...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('tourist-sites-new.show', $touristSite->id) }}" class="btn btn-outline-info mr-2">
    ...
    <form action="{{ route('tourist-sites-new.update', $touristSite->id) }}" method="POST" enctype="multipart/form-data" id="touristSiteForm">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('tourist-sites-new.show', $touristSite->id) }}" class="btn btn-outline-secondary btn-lg">
