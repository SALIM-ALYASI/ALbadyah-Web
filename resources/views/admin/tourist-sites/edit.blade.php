...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('tourist-sites.show', $touristSite->id) }}" class="btn btn-outline-info mr-2">
                        <i class="fas fa-eye mr-1"></i>
                        عرض
                    </a>
                    <a href="{{ route('tourist-sites.index') }}" class="btn btn-outline-secondary">
    ...
    <form action="{{ route('tourist-sites.update', $touristSite->id) }}" method="POST" enctype="multipart/form-data" id="touristSiteForm">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="description_ar" id="description_ar" rows="4" 
                                      ...
                                      placeholder="اكتب وصفاً مفصلاً للموقع باللغة العربية" required>{{ old('description_ar', $touristSite->description_ar) }}</textarea>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="description_en" id="description_en" rows="4" 
                                      ...
                                      placeholder="Write a detailed description of the site in English" required>{{ old('description_en', $touristSite->description_en) }}</textarea>
                        ...
                        <div class="row text-center">
                            <div class="col-6">
                                <div class="border-end">
                                    <h4 class="text-primary mb-1" id="char-count-ar">{{ strlen($touristSite->description_ar) }}</h4>
                                    <small class="text-muted">حرف (عربي)</small>
                                </div>
                            </div>
                            <div class="col-6">
                                <h4 class="text-success mb-1" id="char-count-en">{{ strlen($touristSite->description_en) }}</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('tourist-sites.show', $touristSite->id) }}" class="btn btn-outline-secondary btn-lg">
