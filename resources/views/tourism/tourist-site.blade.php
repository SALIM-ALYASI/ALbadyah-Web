                ...
                @if($touristSite->images->count() > 0)
                    ...
                    <div class="hero-image-container">
                        @if($firstImage->image_path)
                            <img src="{{ asset('storage/' . $firstImage->image_path) }}" alt="{{ $touristSite->name_ar }}" class="hero-image">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="gallery-card">
                    <div class="gallery-image-container">
                        @if($image->image_path)
                            <img src="{{ asset('storage/' . $image->image_path) }}" class="gallery-image" alt="{{ $touristSite->name_ar }}" 
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content modern-modal">
                        <div class="modal-header">
                            <h5 class="modal-title">{{ $touristSite->name_ar }}</h5>
                            <button type="button" class="btn-close modern-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body p-0">
                            @if($image->image_path)
                                <img src="{{ asset('storage/' . $image->image_path) }}" class="modal-image" alt="{{ $touristSite->name_ar }}">
                            @elseif($image->image_url)
                                <img src="{{ $image->image_url }}" class="modal-image" alt="{{ $touristSite->name_ar }}">
                            @else
                                <img src="{{ asset('images/albadyah.jpg') }}" class="modal-image" alt="{{ $touristSite->name_ar }}">
                            @endif
                        </div>
                    </div>
                </div>
