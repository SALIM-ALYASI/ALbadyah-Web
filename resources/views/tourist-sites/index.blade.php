...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('tourist-sitesController.create') }}" class="btn btn-primary">
                    ...
                    <div class="mt-auto">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('tourist-sitesController.show', $site->id) }}" 
                                   class="btn btn-success" title="عرض التفاصيل">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('tourist-sitesController.edit', $site->id) }}" 
                                   class="btn btn-warning" title="تعديل">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('tourist-sitesController.destroy', $site->id) }}" 
    ...
    <div class="card">
        <div class="card-body">
            <div class="empty-state">
                ...
                <a href="{{ route('tourist-sitesController.create') }}" class="btn btn-primary btn-lg">
                    <i class="fas fa-plus"></i>
